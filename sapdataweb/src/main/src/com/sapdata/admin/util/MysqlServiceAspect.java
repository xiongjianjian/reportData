...
@Component
@Aspect
public class MysqlServiceAspect {
     ...
     * @Modified: wuhonghui
     **/
    @Before("execution(* com.sapdata.admin.mysqlservice.impl.*.*(..))")
    public void before(JoinPoint joinPoint) {
        DynamicDataSource.setCustomerDBType(DynamicDataSource.mysqlDataSource);
    }
    /**
     * @Author: wuhonghui
     ...
     * @Modified: wuhonghui
     **/
    @After("execution(* com.sapdata.admin.mysqlservice.impl.*.*(..))")
     ...
     * @Modified: wuhonghui
     **/
    @AfterThrowing(pointcut = "execution(* com.sapdata.admin.mysqlservice.impl.*.*(..))", throwing = "ex")
